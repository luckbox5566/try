...
public class StringXmlParserBianyi {
    /**
     * �������
     */
     ...
     *            Ҫ������������
     */
    public StringXmlParserBianyi(Handler handler,
                                 @SuppressWarnings("rawtypes") Class[] cla) {
        this.handler = handler;
        // this.bingrenXX=bingrenXX;
        // Class cla=bingrenXX.getClass();
        this.cla = cla;

    }

    public StringXmlParserBianyi() {
    }
    ...
    // public static Map<Integer, DR> getDR() {
    //
    // return drmap;
    //
    // }
    ...
    // private DR dr;
    // public static HashMap<Integer, Object> brxxMap = new
    // HashMap<Integer,Object>();
    // public static List<String> value = new ArrayList<String>();
    // public static Map<Integer,String> valueMap=new HashMap<Integer,
    // String>();//����brlb��Ҫ����set��ֵ����
